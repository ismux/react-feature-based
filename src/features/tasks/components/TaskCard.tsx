                        ...
                        <MenuItems className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white py-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                            <MenuItem>
                                <button
                                    ...
                                    onClick={() => navigate(location.pathname + `?viewTask=${task.idDto}`)}>
                                    Ver Tarea
                                </button>
                            </MenuItem>
                            <MenuItem>
                                <button
                                    type="button"
                                    className="block px-3 py-1 text-sm leading-6 text-gray-900 cursor-pointer"
                                    onClick={() => navigate(location.pathname + `?editTask=${task.idDto}`)}>
                                    Editar Tarea
                                </button>
                            </MenuItem>
                            ...
                            <MenuItem>
                                <button
                                    ...
                                    onClick={() => mutate({ projectId, taskId: task.idDto })}
                                >
                                    Eliminar Tarea
                                </button>
                            </MenuItem>
